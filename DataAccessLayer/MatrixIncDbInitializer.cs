...
public static class MatrixIncDbInitializer
{
    public static void Initialize(MatrixIncDbContext context)
    {
        ...
        context.SaveChanges(); // Zorg ervoor dat klanten eerst worden opgeslagen.
        ...
        context.SaveChanges(); // Zorg ervoor dat orders worden opgeslagen nadat klanten zijn opgeslagen.

        // Haal producten op uit de database om de juiste product-id's te gebruiken voor de reviews.
        ...
        context.SaveChanges(); // Sla de reviews op nadat producten en orders zijn toegevoegd.

        context.Database.EnsureCreated(); // Maak de database aan als deze nog niet bestaat
    }
}
